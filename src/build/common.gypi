...
# since gyp_chromium is automatically forcing its inclusion.
{
  ...
  'variables': {
    ...
    'variables': {
	  ...
	  # YYBrowser begin
      #设置yygame业务开关变量，用于控制是否把yygame相关编入到chrome中 added by xpc
      'enable_yygame%': 1,
      # YYBrowser end
  ...
  'target_defaults': {
    'variables': {
      ...
      'win_release_Optimization%': '0', # 2 = /Os
    ...
    'conditions': [
      ...
      #YYBrowser begin
      #打开ENABLE_YYGAME开关 added by xpc
      ['enable_yygame==1', {
        'defines': ['ENABLE_YYGAME=1'],
      }],
      #YYBrowser end
            ...
            'msvs_settings': {
              'VCLinkerTool': {
                'AdditionalOptions': [
                  ...
                  '/ignore:4221',
				  # YYBrowser begin
				  # Changed to /nxcompat:no to allow closing DEP for IE Trident renderer process. modified by midojiang
                  #'/nxcompat',
				  '/nxcompat:no',
				  # YYBrowser end
                ],
