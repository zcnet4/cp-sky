...
"%PYTHON%" build/gyp.py -Dtarget_arch=%target_arch% -Duv_library=%library% server/yworld.gyp
"%PYTHON%" build/gyp.py -Dtarget_arch=%target_arch% -Duv_library=%library% client/yworldclient.gyp
